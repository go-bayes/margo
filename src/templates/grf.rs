...
[baseline]
# WHO variable mode: "default" | "cat" | "num"
# default: hlth_bmi, log_hours_exercise (continuous)
# cat: bmi_cat, who_hours_exercise_cat (categorical)
# num: bmi_cat_num, who_hours_exercise_num (numeric/ordinal)
who_mode = "default"

# baseline covariates for confounding adjustment (39 standard NZAVS vars)
vars = [
  # demographics (12)
  "age",
  "born_nz_binary",
